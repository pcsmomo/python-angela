...
try:
    data = pandas.read_csv("data/cantonese_words_to_learn.csv")
except FileNotFoundError:
    original_data = pandas.read_csv("data/cantonese_words.csv")
...
def is_known():
    ...
    data.to_csv("data/cantonese_words_to_learn.csv", index=False)
    next_card()
